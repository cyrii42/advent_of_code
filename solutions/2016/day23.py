    ...
    def execute_program(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                raise
            # print(f"Register A:  {self.a} (pointer: {self.ptr})")
...
def part_one(data: str):
    ...
    computer.a = 7  # (the number of eggs in the painting)
    computer.execute_program()
    return computer.a

def part_two(data: str):
    ''' https://www.reddit.com/r/adventofcode/comments/5jvbzt/comment/dbjbldd/ '''
    print(math.factorial(12) + (79*77))
